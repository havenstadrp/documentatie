...
function decrypt_action(password_input, encrypted_content, decrypted_content) {
    ...
    if (content) {
        ...
        var node = document.createTextNode('Verkeerd wachtwoord');
...
function init_decryptor() {
    ...
    var encrypted_something = {'mkdocs-encrypted-toc': ['nav', 'class'], 'mkdocs-encrypted-footer': ['div', 'id'], 'mkdocs-encrypted-footer-meta': ['div', 'id']};
