...
| Officiële naam            | Algemeen Wetboek Havenstad |
| Citeertitel               | Wetboek Havenstad |
...
1. Het Wetboek Havenstad (verder aangeduid als WTDA) is leidend voor alle beschreven gevallen, waarbij als aanvulling het Nederlands Recht van toepassing is.
2. Het WTDA heeft betrekking op het vaste land, de gemeente, en de stad Havenstad.
3. Het WTDA is nauw verweven met de Algemene Plaatselijke Verordening Havenstad (APV). De APV dient echter als een indicerend kader voor eventuele bestraffing in-game (“in RP”) en is verder bedoeld voor het afhandelen van straffen buiten de RP om.
...
3. Minderjarigen worden binnen Havenstad op dezelfde manier behandeld als volwassenen. Alle bepalingen, straffen en dergelijke zijn ook van toepassing op hen. Minderjarigen hebben dezelfde rechten en plichten als volwassenen. Het jeugdstrafrecht is in Havenstad niet van toepassing.
...
3. Geldige redenen voor inbeslagname zijn:
    1. Plegen van een strafbaar feit uit het wetboek van Havenstad waarbij het goed direct of indirect betrokken is, behalve fout parkeren en een snelheidsovertreding met uitzondering zoals beschreven in lid E van dit artikel;
...
![Titel I](../../assets/images/Vermogen.png)
...
![Titel II](../../assets/images/Geweld.png)
...
![Titel III](../../assets/images/verkeer.png)
...
![Titel IV](../../assets/images/opium.png)
...
![Titel VII](../../assets/images/kansspellen.png)
...
![Titel VIII](../../assets/images/Overige.png)
...
---------------------
*Wetboek Havenstad is opgesteld uit naam van de Hoge Raad, bedoeld voor het eiland, de gemeente en de stad “Havenstad”, opgetekend door Bram Mosterdfiets, te Havenstad.*
